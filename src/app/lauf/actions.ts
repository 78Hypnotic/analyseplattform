...
export async function createRunAnalysis(input: RunInput): Promise<CreateRunAnalysisState> {
  try {
    ...
    const title = `${parsed.name} · Lauf · ${new Date().toLocaleDateString("de-DE")}`;
