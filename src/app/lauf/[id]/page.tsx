...
export default async function RunAnalysisDetailPage({
  params,
}: {
  ...
  const analysis = await getRunAnalysisById(id);
  ...
  return (
    <>
      ...
      <main className="print-report mx-auto w-full max-w-6xl px-5 py-10">
        ...
        <RunningReportView input={analysis.input} result={analysis.result} />
      </main>
    </>
  );
}
